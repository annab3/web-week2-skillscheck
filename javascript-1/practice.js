...
function oddChecker(num) {
	...
	// }
	return num % 2 === 1 ? "the number is odd" : "the number is even"
}
...
// Code Here
let doubled = myNumbers.map((value) => value * 2)
...
// Code Here
let filtered = myNumbers.filter((value) => value > 100)
...
// Code Here
let total = myNumbers.reduce((value, currValue) => value + currValue)
...
// Code Here
let myNumbersIndex = [];
myNumbers.forEach((elem, index) => myNumbersIndex.push(index));
...
// Code Here
let enemies = people.filter((prop, index) => people[index].friend === false)
...
// Code Here
let totallyAwesome = people.reduce((inc, curr) => people[inc].awesomeLevel + people[curr].awesomeLevel)
